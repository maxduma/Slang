...
const MyPostsContainer = (props) => {
  ...
  return (
    <MyPosts  {...props} posts={props.posts} isHomePage={isHomePage}  addPost={addPost} deletePost={deletePost} addLike={addLike} removeLike={removeLike} authGender={props.authGender}/>
  )
}
...
const mapStateToProps = (state) => {
  return {
    ...
    authGender: state.auth.currentUserData.gender,
